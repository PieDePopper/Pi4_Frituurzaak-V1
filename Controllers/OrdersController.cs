...
namespace Pi4_MVC_Frituurzaak_V3.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CustomerId,OrderregelId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CustomerId,OrderregelId")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
